...
namespace Mindlift.Models
{
    ...
    public partial class Library
    {
        public static Library FromJson(string json) => JsonConvert.DeserializeObject<Library>(json, Mindlift.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Library self) => JsonConvert.SerializeObject(self, Mindlift.Models.Converter.Settings);
    }
